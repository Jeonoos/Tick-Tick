...
partial class Player :  AnimatedGameObject
{
    ...
    private void HandleCollisions()
    {
        ...
        position.X = MathHelper.Clamp(Position.X, sprite.Width / 2, tiles.CellWidth * tiles.Objects.GetLength(0) - sprite.Width / 2);
        position.Y = (float)Math.Floor(position.Y);
        //if (position.X > tiles.CellWidth * tiles.Objects.GetLength(0) - sprite.Width/2)
        //    position.X = tiles.CellWidth * tiles.Objects.GetLength(0) - sprite.Width/2;
